  ...
  if (pfds < this->end_pfds_)
...

    {
      ...
      */
      ...
      {
        ACE_GUARD_RETURN (ACE_SYNCH_RECURSIVE_MUTEX, grd, this->repo_lock_, -1);
                                        ...
                                        ACE_Reactor_Mask mask)
{
  ...
  ACE_MT (ACE_GUARD_RETURN (ACE_SYNCH_RECURSIVE_MUTEX, grd, this->repo_lock_, -1));
...
{
  ACE_MT (ACE_GUARD_RETURN (ACE_SYNCH_RECURSIVE_MUTEX, grd, this->repo_lock_, 0));
